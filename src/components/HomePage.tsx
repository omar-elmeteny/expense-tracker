...
function HomePage() {
    ...
    const topExpenses = [...expenseContext.expenses]
        ...
        <div className="container mt-4">
            ...
            <div className="d-flex justify-content-around flex-wrap justify-content-start">
                {topExpenses.map((expense: Expense) =>
                    <ExpenseCard key={expense.id} id={expense.id} name={expense.name} amount={expense.amount} category={expense.category} isDelete={true} />
                )}
            </div>
